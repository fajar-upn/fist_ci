...
<div class="main-wrapper">
	...
	<!-- Login box.scss -->
	<!-- ============================================================== -->
	<div class="auth-wrapper d-flex no-block justify-content-center align-items-center" <?php echo "style=\"background:url(". base_url() . "includes/assets/images/big/auth-bg.jpg) no-repeat center center;\""; ?>">
