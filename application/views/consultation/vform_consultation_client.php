                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo site_url() ?>consultation/form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" id="select2-with-placeholder" name="university" aria-placeholder="Pilih Universitas" style="width: 100%; height:36px;" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="batch_year" id="batchyear" placeholder="Angkatan" value="<?php echo $data->scons_batch_year; ?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="thesis_title" class="col-sm-3 text-right control-label col-form-label">Judul Skripsi</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" name="thesis_title" id="thesis_title" rows="3" placeholder="Judul Skripsi" required><?php echo $data->scons_thesis_title; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="thesis_description" class="col-sm-3 text-right control-label col-form-label">Deskripsi</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" name="thesis_decription" id="thesis_description" rows="3" placeholder="Deskripsi" required><?php echo $data->scons_thesis_desc; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="supervisor" class="col-sm-3 text-right control-label col-form-label">Dosen Pembimbing</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="supervisor" id="supervisor" placeholder="Dosen Pembimbing" value="<?php echo $data->scons_supervisor; ?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="graduationtarget" class="col-sm-3 text-right control-label col-form-label">Target lulus</label>
                            <div class="col-sm-9">
                                <input type="date" class="form-control" name="graduation_target" id="graduation_target" placeholder="Target lulus" value="<?php echo $data->scons_graduation_target; ?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="proposal_target" class="col-sm-3 text-right control-label col-form-label">TA. 1</label>
                            <div class="col-sm-3">
                                <input type="date" class="form-control" name="proposal_target" id="proposal_target" placeholder="TA. 1" value="<?php echo $data->scons_proposal_target; ?>" required>
                            </div>
                            <label for="proposal_target" class="col-sm-2 text-right control-label col-form-label">TA. 2</label>
                            <div class="col-sm-3">
                                <input type="date" class="form-control" name="thesis_target" id="thesis_target" placeholder="TA. 2" value="<?php echo $data->scons_thesis_target; ?>" required>
                            </div>
                        </div>
                        <hr>
                        <div class="card-body">
                            <!-- <input type="text" hidden id="status" name="status" value="<?php echo $data->sstatus_id; ?>"> -->
