        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo site_url() ?>consultation/status_change/<?php echo $data->scons_id; ?>">
                        <div class="form-group row">
                            <label class="col-sm-3 text-right control-label col-form-label">Pemilihan Paket</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="package" id="package" placeholder="Pilih Universitas" value="<?php echo $data->scpack_code; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="university" class="col-sm-3 text-right control-label col-form-label">Periode</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="periode" id="periode" placeholder="periode" value="<?php echo $data->scperiod_desc; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="university" class="col-sm-3 text-right control-label col-form-label">Tahun</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="year" id="year" placeholder="Tahun" value="<?php echo $data->scperiod_year; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <select class="form-control" name="status" aria-placeholder="Pilih Status">
                                    ...
                                    foreach ($status as $row) {
                                        ...
                                        <?php
                                            ...
                                            <?php if ($row->sstatus_id == '2' || $row->sstatus_id == '3' || $row->sstatus_id == '4') { ?>
